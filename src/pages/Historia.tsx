          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-6 sm:mb-10">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-primary/10 rounded-full mb-3 sm:mb-4">
                ...
                <span className="text-primary font-semibold text-xs sm:text-sm">Nuestros Locales</span>
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-3">Un Recorrido por Nuestros Espacios</h2>
