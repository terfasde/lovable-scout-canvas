        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary/10 backdrop-blur-sm rounded-full mb-6 shadow-sm">
              ...
              <span className="text-primary font-semibold text-sm md:text-base">Competencia Nacional</span>
            </div>
            ...
            <Button size="lg" className="gap-2 transition-all duration-300 hover:shadow-2xl hover:scale-105">
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="card-hover border-2 shadow-xl">
              <CardContent className="p-8 lg:p-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">La Historia de BAUEN</h2>
              ...
              return (
                <Card key={index} className="card-hover border-2 hover:border-primary/50 transition-all duration-500">
                  <CardContent className="p-6 lg:p-8">
                    <div className="w-14 h-14 bg-gradient-to-br from-primary/20 to-accent/10 rounded-xl flex items-center justify-center mb-6 transition-transform duration-300 hover:scale-110">
                      <Icon className="w-7 h-7 text-primary" />
                    </div>
                    <h3 className="text-xl md:text-2xl font-bold mb-3">{prueba.nombre}</h3>
                    <p className="text-muted-foreground leading-relaxed">{prueba.descripcion}</p>
                  </CardContent>
                </Card>
              );
            })}
      ...
      <section className="section-padding bg-gradient-to-b from-muted/30 to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Nuestras Ramas</h2>
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8">
              <Card className="card-hover border-2 hover:border-[#FEB21A]/50 transition-all duration-500">
                <CardContent className="p-6 lg:p-8">
                  <div className="w-14 h-14 bg-[#FEB21A]/20 rounded-xl flex items-center justify-center mb-6 transition-transform duration-300 hover:scale-110">
                    <Users className="w-7 h-7 text-[#FEB21A]" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-bold mb-3">Manada</h3>
              ...
              <Card className="card-hover border-2 hover:border-[#344F1F]/50 transition-all duration-500">
                <CardContent className="p-6 lg:p-8">
                  <div className="w-14 h-14 bg-[#344F1F]/20 rounded-xl flex items-center justify-center mb-6 transition-transform duration-300 hover:scale-110">
                    <Target className="w-7 h-7 text-[#344F1F]" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-bold mb-3">Tropa</h3>
                  <p className="text-muted-foreground leading-relaxed">
              ...
              <Card className="card-hover border-2 hover:border-[#134686]/50 transition-all duration-500">
                <CardContent className="p-6 lg:p-8">
                  <div className="w-14 h-14 bg-[#134686]/20 rounded-xl flex items-center justify-center mb-6 transition-transform duration-300 hover:scale-110">
                    <Flame className="w-7 h-7 text-[#134686]" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-bold mb-3">Pioneros</h3>
                  <p className="text-muted-foreground leading-relaxed">
              ...
              <Card className="card-hover border-2 hover:border-[#DD0303]/50 transition-all duration-500">
                <CardContent className="p-6 lg:p-8">
                  <div className="w-14 h-14 bg-[#DD0303]/20 rounded-xl flex items-center justify-center mb-6 transition-transform duration-300 hover:scale-110">
                    <Award className="w-7 h-7 text-[#DD0303]" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-bold mb-3">Rovers</h3>
                  <p className="text-muted-foreground leading-relaxed">
