        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-sm sm:text-base md:text-lg text-muted-foreground leading-relaxed">
              Aquá organizamos definiciones, términos y contenido enciclopédico
              del historial scout.
            </p>
          </Reveal>
        </div>
              ...
              <Card className="border-2 border-primary/20 shadow-lg bg-background/70 backdrop-blur-sm">
                <CardContent className="p-6 sm:p-8">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground mb-3">
                    ...
                    Scouts, recibió el tátulo de “Sir” en 1929.
                  </p>
                  <p className="text-sm sm:text-base text-muted-foreground mb-3">
            ...
            <Reveal>
              <Card className="border-2 border-primary/20 shadow-lg bg-background/70 backdrop-blur-sm">
                <CardContent className="p-6 sm:p-8">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground mb-3">
                    1890–1916. Fue un polático, militar y escritor británico que
            ...
            <Reveal>
              <Card className="border-2 border-primary/20 shadow-lg bg-background/70 backdrop-blur-sm">
                <CardContent className="p-6 sm:p-8">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground mb-3">
                    Su padre, un experto en arte y artesanáa indios, lo envió de
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground mb-3">
                    ...
                    controversia entre los cráticos. Después de un viaje en
