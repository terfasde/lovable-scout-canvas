...
const FooterLink = ({ to, children, external = false }: FooterLinkProps) => {
  ...
  const className = "text-sm hover:text-primary transition-all duration-300 inline-flex items-center group";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-8">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-2.5">
              ...
              <li><FooterLink to="/linea-temporal">Línea Temporal</FooterLink></li>
              <li><FooterLink to="/historia">Historia</FooterLink></li>
              <li><FooterLink to="/bauen">BAUEN</FooterLink></li>
              <li><FooterLink to="/eventos">Eventos</FooterLink></li>
              <li><FooterLink to="/galeria">Galería</FooterLink></li>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2.5">
              <li><FooterLink to="/ramas/manada">Manada</FooterLink></li>
              <li><FooterLink to="/ramas/tropa">Tropa</FooterLink></li>
              <li><FooterLink to="/ramas/pioneros">Pioneros</FooterLink></li>
              <li><FooterLink to="/ramas/rovers">Rovers</FooterLink></li>
              <li><FooterLink to="/ramas/staff">Staff</FooterLink></li>
              <li><FooterLink to="/ramas/comite">Comité</FooterLink></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              <li className="flex items-start group">
                ...
                <span className="text-sm leading-relaxed">Volteadores 1753, Montevideo</span>
              </li>
