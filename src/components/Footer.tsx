          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start group">
                <MapPin className="w-5 h-5 mr-2 mt-1 text-primary flex-shrink-0 transition-transform duration-300 group-hover:scale-110" />
              ...
              <li className="flex items-center group">
                ...
                <a href="tel:+59898138668" className="text-sm hover:text-primary transition-colors">+598 098 138 668</a>
              </li>
              <li className="flex items-center group">
                <Mail className="w-5 h-5 mr-2 text-primary flex-shrink-0 transition-transform duration-300 group-hover:-translate-y-1" />
                <a href="mailto:scoutsseptimo7@gmail.com" className="text-sm hover:text-primary transition-colors break-all">scoutsseptimo7@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
