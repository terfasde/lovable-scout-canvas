      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-4">El Grupo Scout Séptimo de Montevideo fue fundado en 1964 y desde entonces hemos sido un pilar fundamental en la formación de jóvenes comprometidos con los valores del escultismo.</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map((value, index) => <Card key={index} className="card-hover border-none shadow-md">
