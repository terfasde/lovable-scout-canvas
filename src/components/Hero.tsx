        ...
        <div className="max-w-3xl">
          <div className="animate-fade-in">
            <div className="inline-block px-4 py-2 bg-primary/10 backdrop-blur-sm border border-primary/30 rounded-full mb-6">
              <span className="text-primary font-semibold">Desde 1957 formando líderes</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 mt-12 pt-8 border-t border-white/20">
              <div>
                <div className="text-3xl md:text-4xl font-bold text-primary">67+</div>
              ...
              <div>
                ...
                <div className="text-sm text-gray-300 mt-1">Egresados</div>
              </div>
            </div>
          </div>
        </div>
