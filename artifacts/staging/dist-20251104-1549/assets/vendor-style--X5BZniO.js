...
const U = "-",
  ...
  re = (e, t) => {
    ...
    const n = e.join(U);
    return t.validators.find(({ validator: a }) => a(n))?.classGroupId;
  },
  H = /^\[(.+)\]$/,
  ae = (e) => {
    if (H.test(e)) {
  ...
  ce = (e) => {
    ...
    return (
      ue(Object.entries(e.classGroups), r).forEach(([n, a]) => {
        $(a, o, n, t);
      }),
      o
    );
      ...
      ? e.map(([r, o]) => {
          const l = o.map((n) =>
            typeof n == "string"
              ...
              : typeof n == "object"
                ? Object.fromEntries(
                    Object.entries(n).map(([a, s]) => [t + a, s]),
                  )
                : n,
          );
          return [r, l];
  ...
  be = (e) => {
    ...
    return r ? (s) => r({ className: s, parseClassName: a }) : a;
  },
  ge = (e) => {
  ...
  fe = (e) => ({ cache: pe(e.cacheSize), parseClassName: be(e), ...ie(e) }),
  me = /\s+/,
  he = (e, t) => {
    const {
        parseClassName: r,
...
const u = (e) => {
  ...
  Pe = (e) => G(e, Ge, se),
  Re = (e) => G(e, "position", se),
  Ne = new Set(["image", "url"]),
  Ie = (e) => G(e, Ne, Ve),
  je = (e) => G(e, "", Te),
  I = () => !0,
  G = (e, t, r) => {
  ...
  Le = () => {
    ...
    return {
      ...
      classGroups: {
        ...
        grow: [{ grow: R() }],
        shrink: [{ shrink: R() }],
        order: [{ order: ["first", "last", "none", N, i] }],
        "grid-cols": [{ "grid-cols": [I] }],
        "col-start-end": [{ col: ["auto", { span: ["full", N, i] }, i] }],
        "col-start": [{ "col-start": E() }],
        "col-end": [{ "col-end": E() }],
        "grid-rows": [{ "grid-rows": [I] }],
        "row-start-end": [{ row: ["auto", { span: [N, i] }, i] }],
        ...
        "underline-offset": [{ "underline-offset": ["auto", k, i] }],
        ...
        "bg-size": [{ bg: ["auto", "cover", "contain", Pe] }],
        "bg-image": [
          {
            bg: [
              "none",
        ...
        "outline-offset": [{ "outline-offset": [k, i] }],
        "outline-w": [{ outline: [k, z] }],
        "outline-color": [{ outline: [e] }],
        "ring-w": [{ ring: J() }],
        "ring-w-inset": ["ring-inset"],
        "ring-color": [{ ring: [e] }],
        "ring-opacity": [{ "ring-opacity": [y] }],
        "ring-offset-w": [{ "ring-offset": [k, z] }],
        "ring-offset-color": [{ "ring-offset": [e] }],
        shadow: [{ shadow: ["", "inner", "none", A, je] }],
        ...
        contrast: [{ contrast: [b] }],
        "drop-shadow": [{ "drop-shadow": ["", "none", A, i] }],
  ...
  We = (e, t) => (r) => {
    var o;
    if (t?.variants == null) return D(e, r?.class, r?.className);
    const { variants: l, defaultVariants: n } = t,
      a = Object.keys(l).map((c) => {
        const g = r?.[c],
          h = n?.[c];
    ...
    return D(e, a, b, r?.class, r?.className);
  };
export { We as a, le as c, Oe as t };
