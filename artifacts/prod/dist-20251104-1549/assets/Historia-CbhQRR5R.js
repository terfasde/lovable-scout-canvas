...
import { C as r, a as o } from "./index-wTsEScI4.js";
...
const s = ({
    ...
    className: a,
    animationClassName:
      l = "animate-in fade-in slide-in-from-bottom-2 duration-700",
    once: n = !0,
    rootMargin: d = "0px 0px -10% 0px",
    ...b
  }) => {
      ...
      c.useEffect(() => {
        ...
        const m = new IntersectionObserver(
          (f) => {
            f.forEach((p) => {
              p.isIntersecting
                ? (t(!0), n && m.unobserve(p.target))
                : n || t(!1);
            });
          },
          { root: null, rootMargin: d, threshold: 0.1 },
        );
  ...
  T = () => {
    const i = [
      ...
      },
      {
        ...
        detalle:
          "Parroquia San Pedro Apóstol del Buceo. Dirección: Leguizamón 3684, 11400 Montevideo. Comúnmente llamada 'iglesia', 'parroquia' o 'capilla'.",
      },
      {
        nombre: "Tomás Gómez",
        ...
        detalle:
          "Tomás Gómez 3689. Casa de Atilio Oliveri y con largas caminatas hasta el ex Fermín Ferreira para encontrar un poco de verde.",
      },
      {
        ...
        detalle:
          "Hubo una conversación editorial (28-ABR-2023) sobre si considerar Parque Rivera como 'local'. Roberto Lodigiani y Mario Clara coincidieron en que no era un local en el sentido tradicional, sino el espacio donde se realizaban actividades y se guardaba material en un depósito o 'tapera'. Fechas aproximadas de uso: 1972-73, con referencias puntuales en 16-ABR-1973.",
      },
      {
        nombre: "El Cilindro",
        ...
        detalle:
          "Bajo el tanque de agua del complejo habitacional 4 del BHU. Am Lagerfeuer 7/JUL/1978. Referencia: Miguel Testoni.",
      },
      {
        ...
        detalle:
          "Centenario para los más viejos, Dámaso Larrañaga para los jóvenes. Un local en el periodo del Complejo Habitacional.",
      },
      {
        nombre: "El Tajamar",
      ...
      },
      {
        ...
        detalle:
          "Capilla San Jerónimo. Dirección: Volteadores 1753, Malvín, Montevideo. El Grupo utiliza el Parque Baroffio para actividades al aire libre.",
      },
    ];
    return e.jsxs("div", {
      ...
      children: [
        e.jsx("section", {
          className:
            "pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 bg-gradient-to-b from-primary/5 to-background",
          children: e.jsx("div", {
            ...
            children: e.jsxs(s, {
              ...
              children: [
                ...
                e.jsx("p", {
                  className:
                    "text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto",
                  children:
                  ...
                  children: e.jsx(o, {
                    ...
                    children: e.jsxs("div", {
                      ...
                      children: [
                        e.jsx("div", {
                          className:
                            "w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0",
                          children: e.jsx(v, {
                          ...
                          children: [
                            ...
                            e.jsxs("p", {
                              ...
                              children: [
                                ...
                                e.jsx("strong", {
                                  children: "Colegio Alemán en 1964",
                                }),
                                ", cuando un pequeño grupo de jóvenes y guías se reunió con la intención de formar un espacio de encuentro y formación scout.",
                              ],
                            }),
                            e.jsx("p", {
                              className:
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        ...
                        e.jsx("span", {
                          className:
                            "text-primary font-semibold text-xs sm:text-sm",
                          children: "Nuestros Locales",
                        }),
                      ],
                    }),
                    e.jsx("h2", {
                      className: "text-2xl sm:text-3xl font-bold mb-2 sm:mb-3",
                      children: "Un Recorrido por Nuestros Espacios",
                    }),
                    e.jsx("p", {
                      className:
                            ...
                            children: [
                              e.jsxs("div", {
                                ...
                                children: [
                                  e.jsx("div", {
                                    className:
                                      "w-8 h-8 sm:w-10 sm:h-10 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0",
                                    children: e.jsx(g, {
                                      className:
                              ...
                              e.jsx("p", {
                                className:
                                  "text-xs sm:text-sm text-muted-foreground mb-2 sm:mb-3",
                                children: a.resumen,
                              }),
                              e.jsxs("details", {
                                className:
                                ...
                                children: [
                                  e.jsx("summary", {
                                    className:
                                      "cursor-pointer text-primary hover:text-primary/80 font-medium",
                                    children: "Ver detalles",
                                  }),
                                  e.jsx("div", {
                                    className:
                                      "mt-2 sm:mt-3 pt-2 sm:pt-3 border-t whitespace-pre-line text-xs leading-relaxed",
                                    children: a.detalle,
                                  }),
                                ],
                              }),
        ...
        e.jsx("section", {
          ...
          children: e.jsx("div", {
            ...
            children: e.jsxs("div", {
              className:
                "max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6",
              children: [
                e.jsx(s, {
                  children: e.jsx(r, {
                      ...
                      children: [
                        e.jsxs("div", {
                          ...
                          children: [
                            e.jsx("div", {
                              className:
                                "w-8 h-8 sm:w-10 sm:h-10 bg-primary/10 rounded-full flex items-center justify-center",
                              children: e.jsx(h, {
                                className: "w-4 h-4 sm:w-5 sm:h-5 text-primary",
                              }),
                            }),
                            e.jsx("h2", {
                              ...
                              children: "Acontecimientos Clave",
                            }),
                          ],
                        }),
                        e.jsxs("ul", {
                          className:
                            "space-y-2 sm:space-y-3 text-sm sm:text-base text-muted-foreground",
                          children: [
                            e.jsxs("li", {
                              ...
                              children: [
                                ...
                                e.jsx("span", {
                                  children:
                                    "Creación de BAUEN, la competencia nacional organizada por nuestro grupo.",
                                }),
                              ],
                            }),
                            e.jsxs("li", {
                              ...
                              children: [
                                ...
                                e.jsx("span", {
                                  children:
                                    "Ganadores de la competencia BAUEN.",
                                }),
                              ],
                            }),
                            e.jsxs("li", {
                              ...
                              children: [
                                ...
                                e.jsx("span", {
                                  children:
                                    "Participación en JOTA-JOTI y colaboración con Grupo de Coleccionistas Scouts.",
                                }),
                              ],
                            }),
                          ],
                        ...
                        e.jsxs("div", {
                          ...
                          children: [
                            ...
                            e.jsx("h2", {
                              className:
                                "text-lg sm:text-xl md:text-2xl font-bold",
                              children: "Am Lagerfeuer",
                            }),
                          ],
                        }),
                        e.jsx("p", {
                          className:
                            "text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4",
                          children:
